...
void LCD_setup(void)
{
	...
	Draw_String_BG(0,linspace*0,"Select LED", WHITE,BLACK,&font_ubuntu_mono_24);
	Draw_String_BG(0,linspace*1,"RED", RED,BLACK,&font_ubuntu_mono_24);
	Draw_String_BG(0,linspace*2,"GREEN", GREEN,BLACK,&font_ubuntu_mono_24);
	Draw_String_BG(0,linspace*3,"BLUE", BLUE,BLACK,&font_ubuntu_mono_24);
